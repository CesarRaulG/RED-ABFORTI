...
/*
   ...
   */
    ...
    // Directorio base
    $directorioBase = $_SERVER['DOCUMENT_ROOT'] . "/super_users/abforti/uploads/factura/{$anoActual}/{$mesActual}/NO_RECURRENTES/{$diaActual}";
...
error_log("Nombre Archivo PDF: " . $nombreArchivoPDF);
error_log("Nombre Archivo XML: " . $nombreArchivoXML);
