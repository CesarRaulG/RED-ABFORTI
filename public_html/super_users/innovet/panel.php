...
<div class="row">
		...
		<div class="card">
			<div class="card-header">
				<a href="invoice-list.php">
					<p><h4>Proveedor</h4><?php countProviders('IN') ?>
				</a>
			</div>
		</div>
	</div>
		...
		<div class="card">
			<div class="card-header">
				<a href="invoice-nrec.php">
					<h4>No recurrentes</h4><?php countNoRecurrent('IN') ?>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-md-6 mb-3">
		<div class="card">
			<div class="card-header">
				<a href="invoice-fixed_fund.php">
					<h4>Fondos fijos departamentos</h4><?php countFixedFound('IN') ?>
				</a>
			</div>
		</div>
	</div>
