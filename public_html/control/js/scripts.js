...
/////////////////////////////////////////////////////////////////////////	
	...
	$(document).on('click', ".delete-customer", function(e) {
	   ...
	   $("#action_update_mf").click(function(e) { 
		e.preventDefault();
		updateMF();
		});
	...
	function updateMF() {
		...
		if (errorCounter > 0) {
			...
			$(".required").parent().removeClass("has-error");
			var formData = new FormData($("#update_mf")[0]);
			var $btn = $("#action_update_mf").button("loading");
	...
	//Comprobante de pago:
	$("#action_payment_receipt").click(function(e) {
		e.preventDefault();
	    actionPaymentReceipt();
	});
	
	function actionPaymentReceipt(){	
		...
		if (errorCounter > 0) {
			...
			var formData = new FormData($("#payment_receipt")[0]);
			var $btn = $("#action_payment_receipt").button("loading");
	...
	//Comprobante de pago:
	$("#action_upload_more").click(function(e) {
		e.preventDefault();
	    actionUploadMore();
	});
	...
	function actionUploadMore(){
		...
		if (errorCounter > 0) {
			...
			var formData = new FormData($("#upload_more")[0]);
			var $btn = $("#action_upload_more").button("loading");
