                    ...
                    <div class="row">
                        <div class="col-xs-6">                            
                            ...
                            <div class="col-sm mb-3">
                                ...
                                <input type="text" class="form-control margin-bottom copy-input required" name="direccion" id="direccion" placeholder="Direccion" tabindex="2" value="<?php echo htmlspecialchars($direccion); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                    ...
                    <div class="row">
                        <div class="col-xs-6">                            
                            <div class="col-sm mb-3">
                                ...
                                <input type="text" class="form-control margin-bottom copy-input required" name="cuenta" id="cuenta" placeholder="Cuenta" tabindex="1" value="<?php echo htmlspecialchars($cuenta); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                                <label for="clabe">Clabe</label>
                                <input type="text" class="form-control margin-bottom copy-input required" name="clabe" id="clabe" placeholder="Clabe" tabindex="2" value="<?php echo htmlspecialchars($clabe); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                                <label for="moneda">Moneda</label>
                                <input type="text" class="form-control copy-input required" name="moneda" id="moneda" placeholder="Moneda" tabindex="4" value="<?php echo htmlspecialchars($moneda); ?>" >
                            </div>
                            <div class="col-sm mb-3" id="swift-container">
                                <label for="swift">Swift</label>
                                <input type="text" class="form-control copy-input required" name="swift" id="swift" placeholder="Swift" tabindex="3" value="<?php echo htmlspecialchars($swift); ?>" >
                            </div>                            
                        </div>
                        <div class="col-xs-6">                                                                                                    
                            <div class="col-sm mb-3">
                                <label for="banco">Banco</label>
                                <input type="text" class="form-control copy-input required" name="banco" id="banco" placeholder="Banco" tabindex="5" value="<?php echo htmlspecialchars($banco); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                                <label for="titular">Titular</label>
                                <input type="text" class="form-control copy-input required" name="titular" id="titular" placeholder="Titular" tabindex="5" value="<?php echo htmlspecialchars($titular); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                                <label for="referencia">Referencia</label>
                                <input type="text" class="form-control copy-input required" name="referencia" id="referencia" placeholder="Referencia" tabindex="5" value="<?php echo htmlspecialchars($referencia); ?>" >
                            </div>
                            <div class="col-sm mb-3">
                                <label for="concepto">Concepto</label>
                                <input type="text" class="form-control copy-input required" name="concepto" id="concepto" placeholder="Concepto" tabindex="5" value="<?php echo htmlspecialchars($concepto); ?>" >
                            </div>                                                     
                        </div>
                    </div>
                </div>        		
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="col-sm mb-3">
                                ...
                                <input type="text" class="form-control margin-bottom copy-input required" name="credito" id="credito" placeholder="Días de crédito" value="<?php echo htmlspecialchars($credito); ?>">
                            </div>
                        </div>    
                    </div>                                                       
                </div>
