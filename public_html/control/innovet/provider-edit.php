...
<form method="post" id="update_mf" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xs-6">                            
                            ...
                            <div class="col-sm mb-3">
                                ...
                                <input type="text" class="form-control copy-input" name="correo_electronico" id="correo_electronico" placeholder="Correo Electronico" tabindex="4" value="<?php echo htmlspecialchars($correo_electronico); ?>" >
                            </div>                            
                        </div>
                        <div class="col-xs-6">
                            <div class="col-sm mb-3">
                                <label for="razon_social">Razon Social</label>
                                <input type="text" class="form-control copy-input" name="razon_social" id="razon_social" placeholder="Razon Social" tabindex="3" value="<?php echo htmlspecialchars($razon_social); ?>" readonly >
                            </div>                
                            
                            <br>
                            <div class="col-sm mb-3">
                                <label for="telefono">Telefono</label>
                                <input type="text" class="form-control copy-input" name="telefono" id="telefono" placeholder="Telefono" tabindex="5" value="<?php echo htmlspecialchars($telefono); ?>" >
                            </div>                                                        
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12 col-md-4">
            ...
            <div class="mb-3">
            <input type="hidden" name="id_proveedor" value="<?php echo $postID; ?>">
            <input type="button" id="action_update_mf" class="btn btn-success float-right" value="Actualizar Proveedor">
            </div>
        </div>
    </div>
</form>
