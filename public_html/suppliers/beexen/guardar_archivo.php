...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['archivo_temporal'])) {
    ...
    // Directorio base
    $directorioBase = $_SERVER['DOCUMENT_ROOT'] . "/suppliers/beexen/uploads/factura/";
