...
<h1>Datos de la factura (<?php echo $postID; ?>)</h1>
<hr>
    ...
    <div class="row">
        ...
        <div class="col-xs-7 table-responsive">            
            <table >
                <thead>
                    <tr>
                        <th>Subtotal: <span style="margin-left: 400px;">$ <?php echo $cfdiData['subtotal']; ?></span></th>
                    </tr>
                    <tr>
                        <th>Impuesto traslados: <span style="margin-left: 320px;">$<?php foreach ($trasladosData as $traslados) : ?>                        
                        <?php echo $traslados['importe']; ?>                       
                        <?php endforeach; ?></span></th>                    
                    </tr>
                    <tr>
                        <th>Impuesto retenidos: <span style="margin-left: 320px;">$<?php foreach ($retencionesData as $retencion) : ?>                        
                          <?php echo $retencion['importe']; ?>                         
                            <?php endforeach; ?></span></th>  
                    </tr>
                    <tr>                
                        <th>Total:<span style="margin-left: 430px;">$ <?php echo $cfdiData['total']; ?></span></th>                                                                                      
                    </tr>
                </thead>                
            </table>
        </div>
