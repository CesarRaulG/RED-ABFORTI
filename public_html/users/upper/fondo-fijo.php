...
class FacturaValidator {
    private $rfc_receptor_esperado = "SOL090407QG0";
            ...
            if (move_uploaded_file($tmp_file, $tempFilePath)) {
                ...
                try {
                    ...
                    if ($mesEmision !== $mesActual) {
                        $this->erroresPorArchivo[$nombreOriginal][] = 'El XML no corresponde al mes actual.';
                        continue;
                    }
*/
                ...
                <tbody>
                    <?php foreach ($resultados as $key => $resultado): ?>
                        <tr id="fila-<?php echo $key; ?>">
                            ...
                            <td>
                                <form enctype="multipart/form-data" id="fondo_fijo_u" class="form-guardar" data-id="<?php echo $key; ?>">
                                    
                                    <input type="hidden" name="action" value="fondo_fijo_u">
