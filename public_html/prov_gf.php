...
if (isset($_FILES) && !empty($_FILES)) {
    ...
    $razon_social_F = $_POST['razon_social_F'];
    echo "La razón social para personas físicas es: " . $razon_social_F;
    ...
    $directorioRazonSocial = $directorioPermanente . $razon_social_F . "/";
